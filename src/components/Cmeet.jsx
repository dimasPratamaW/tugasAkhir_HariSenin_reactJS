...
const Cmeet = () => {
  ...
  <div class="flex w-full justify-center items-center text-4xl font-primary md:text-7xl gap-4">
    <p>Kompleks</p>
    <img src="./assets/images/arrow.png" width="50" height="50" alt="arrow" class="hidden lg:block w-20" />
    <p>bertemu</p>
    <img src="./assets/images/arrow-2.png" width="50" height="50" alt="arrow" class="hidden md:block w-20" />
    <p>intuitif</p>
  </div>
...
<div
  ...
  <div class="text-center font-primary gap-4 md:gap-10 text-red-950 grid px-3 xl:px-14">
    <h3 class="md:text-4xl text-2xl flex flex-col">
      Penjualan kostum
      <img src="assets/images/arrow-section.png" width="30" height="25" alt="arrow" loading="lazy"
  ...
  <div class="hidden xl:block md:max-w-[900px]">
    <img src="./assets/images/hero-gambar.png" alt="tumbnail" class="w-full h-auto object-cover" />
  </div>
